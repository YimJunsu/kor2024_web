...
public class RestController4 {
    ...
    @GetMapping("")
    // 요청 : [GET] http://localhost:8080/day56/rest4?key=1유재석&key2=강호동
    public boolean getRest4(@RequestParam String key1, @RequestParam String key2){
        ...
        return true;
    } // 응답 : Content-Type : 'application/json' (@RestController(@ResponseBody))

    @GetMapping("/dto") // [GET] http://localhost:8080/day56/rest4/dto?key=1유재석&key2=강호동
