...
public class main {
    ...
    //  빌더패턴 인스턴스생성 vs 생성자 인스턴스 생성
        ...
        // 4. 회원 객체의 게시물 확인, 게시물 객체는 회원객체를 참조하지만 회원객체는 게시물 객체를 참조하지 않는다.
        // System.out.println("강호동의 게시물 확인 : " + m1.???);

        // ========= 양( 서로 참조 ) 방향 연관관계, 데이터베이스 에서는 표현 불가능하다. =====

        // 5. 양방향 설정, 회원객체에 게시물 객체 대입
        m1.get작성한게시물().add(b1); // m1(강호동) 객체에 b1(1번게시물)객체를 대입했다.

        System.out.println(m1);
        //@ToString 사용하지 않았을때 : day64.객체연관관계.회원@65b54208
